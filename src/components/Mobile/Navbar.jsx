...
const MobileNavbar = () => {
  ...
  return (
    < >
        ...
        <Link id="home" className="menu-item" href={isLogin?"/":''}>Home</Link>
        <Link id="about" className="menu-item" href={isLogin?"/add-task":''}>Add Task</Link>
        <Link id="contact" className="menu-item" href={isLogin?"/show-tasks":''}>Tasks</Link>
